...
elem.style.height=0;let newHeight=Math.max(minHeight,elem.scrollHeight);if(maxHeight>0){newHeight=Math.min(newHeight,maxHeight);}else{elem.style.overflow='hidden';}
