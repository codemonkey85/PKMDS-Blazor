...
public partial class MarkingComponent
{
    ...
    private string MarkingClass =>
        $"w-[100px] aspect-square flex justify-center items-center text-[3.0rem] text-center cursor-pointer select-none border border-gray-300 rounded-[10px]{Pokemon?.GetMarking((int)Shape) switch
        {
            null => string.Empty,
            0 => " text-gray-500",
